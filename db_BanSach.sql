...
--
-- Host: localhost:3306
-- Generation Time: Dec 08, 2024 at 03:29 AM
...
(4, 'Cánh đồng bất tận', 'Nguyễn Ngọc Tư', 100, 'canh_dong_bat_tan.jpg', 'Cuộc sống miền Tây Nam Bộ với nhiều góc nhìn nhân văn.', 54, 22),
...
(7, 'Công nghệ tương lai', 'Michio Kaku', 230, 'cong_nghe_tuong_lai.jpg', 'Những đột phá về công nghệ trong thế kỷ 21.', 0, 20),
(8, 'Trí tuệ nhân tạo: Kỷ nguyên mới', 'Max Tegmark', 220, 'tri_tue_nhan_tao.jpg', 'AI và tác động của nó đến xã hội và công việc.', 0, 20),
(9, 'Blockchain và Bitcoin', 'Andreas M. Antonopoulos', 300, 'blockchain_bitcoin.jpg', 'Công nghệ blockchain và ứng dụng của nó trong kinh tế.', 0, 20),
(10, 'Vật lý lượng tử cho mọi người', 'Christophe Galfard', 180, 'vat_ly_luong_tu.jpg', 'Khám phá vật lý lượng tử một cách đơn giản.', 0, 33),
...
(25, 'Alice ở xứ sở thần tiên', 'Lewis Carroll', 250, 'alice_xu_so_than_tien.jpg', 'Câu chuyện kỳ ảo về cuộc phiêu lưu của cô bé Alice.', 215, 31),
